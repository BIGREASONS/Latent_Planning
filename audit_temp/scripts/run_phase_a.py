...
def build_split_trajectories(
    model, tokenizer, data_dir, layer, cap, out_dir, batch_size=32
):
    trajs = {}
...
def main():
    ...
    parser.add_argument(
        ...
        type=int,
        metavar="SIZE",
        default=[5000, 500, 1000, 500],
        help="Generate data if missing. E.g. 5000 500 1000 500 (train val test test_ood)",
    )
