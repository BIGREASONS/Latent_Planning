...
# --------------------------------------------------------------------------- #
def maybe_generate_data(data_dir: str, sizes, domain: str = "countdown") -> None:
    ...
    if len(sizes) > 3:
        ...
        if existing_ood < n_ood:
            ...
            generate_dataset(n_ood, path_ood, is_ood=True)
...
def main():
    ...
    if args.generate:
        ...
        maybe_generate_data(args.data_dir, args.generate, domain=args.domain)
