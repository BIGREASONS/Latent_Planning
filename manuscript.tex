...
Email: vaibhav.singh@vitbhopal.ac.in \\
...
Semantic Gain measures the transition model's ability to inject valid action-conditioned semantics beyond simply passing through the current state. We define a blind baseline, $\hat h_{blind} = \mathcal{T}_\phi(h_t, \mathbf{0})$. Semantic Gain is defined as:
\begin{equation}
...
\begin{itemize}
    ...
    \item \textbf{Single Teacher:} We restrict our experiments to TinyLlama-1.1B. 
...
\appendix
\section*{Final Audited Phase 3 Raw Results}
