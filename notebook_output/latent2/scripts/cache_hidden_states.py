...
def main():
    ...
    parser.add_argument(
        "--data_file", type=str, required=True, help="Input JSONL problems file"
    )
    parser.add_argument(
        "--output_file", type=str, required=True, help="Output .pt trajectories file"
    )
    ...
    print(
        f"Successfully built {len(trajectories)} trajectories. Saving to {args.output_file}..."
    )
